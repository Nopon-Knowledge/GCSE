...
# from senet.gcse_module import GCSEAttention  # GCSE module (manual switch for comparison)
...
class SEBasicBlock(nn.Module):
    """
    Basic ResNet block with SENet attention.
    Structure: Conv-BN-ReLU -> Conv-BN -> SE -> residual add -> ReLU
    """
    expansion = 1
...
class SEBottleneck(nn.Module):
    """
    Bottleneck SENet-ResNet block for 50/101/152 variants.
    Structure: 1x1 reduce -> 3x3 -> 1x1 expand -> SE -> residual add -> ReLU
    """
    expansion = 4
...
def se_resnet101(num_classes=1_000):
    """Build a SENet-ResNet-101 model."""
...
def se_resnet152(num_classes=1_000):
    """Build a SENet-ResNet-152 model."""
...
class CifarSEBasicBlock(nn.Module):
    """SENet basic block for CIFAR inputs."""
...
class CifarSEResNet(nn.Module):
    """
    SENet-ResNet for CIFAR (32x32).
    block: basic block type (CifarSEBasicBlock)
