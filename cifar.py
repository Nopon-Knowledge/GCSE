...
from gcse.baseline import resnet20
from gcse.gcse_resnet import gcse_resnet20
# SENet comparison (optional): from senet.se_resnet import se_resnet20
...
def main():
    ...
    if args.baseline:
        ...
        model = gcse_resnet20(num_classes=10, reduction=args.reduction)
